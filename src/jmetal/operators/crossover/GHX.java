 ...
 * solutions.
 */
public class GHX extends Crossover {
  /**
   ...
   */
  public GHX(HashMap<String, Object> parameters) {
  	super (parameters) ;
  ...
  public Solution[] doCrossover(double probability, 
                                Solution parent1, 
                                Solution parent2,
                                Solution parent3,Solution parent4, double P1, double P2) throws JMException {
...
//    offSpring[2] = new Solution(parent1);
    ...
    double valueX1,valueX2,valueX3,valueX4;
    double r2, W, C2;
