...
public class MOP6 extends Problem {
	...
	public MOP6(String solutionType, Integer numberOfVariables, Integer numberOfObjectives)
	...
	public void evaluate(Solution solution) throws JMException {
	    ...
	    f[0] = (1.0 + g) * x.getValue(0) * x.getValue(1);
	    f[1] = (1.0 + g) * x.getValue(0) * (1.0 - x.getValue(1));
	    f[2] = (1.0 + g) * (1.0 - x.getValue(0));
